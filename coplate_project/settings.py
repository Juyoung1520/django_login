...
SECRET_KEY = ')k_i%(_s*asiho28n^z+n4m5xj9tlc*)e%ido8d$uwmn3e%v_&'
...
AUTHENTICATION_BACKENDS = [
    ...
    # 'allauth' specidic authentication methods, such as login by e-mail
...
ACCOUNT_SIGNUP_FORM_CLASS = "coplate.forms.SignupForm"  #추가
